"""
EAGLE-3 + LLaMA: Hand-rolled speculative decoding with SDC-oriented trace.
...
Usage
-----
python eagle3_llama_speculative.py \\
...
class Eagle3DraftHead(nn.Module):
    ...
    def __init__(self, draft_ckpt_path: str, target_model: nn.Module):
        ...
        self.draft_layer = LlamaDecoderLayer(cfg, layer_idx=0)
...
def main():
    ...
    parser.add_argument("--base_model_id",  default="meta-llama/Llama-3.1-8B-Instruct")
    parser.add_argument("--draft_model_id", default="yuhuili/EAGLE3-LLaMA3.1-Instruct-8B")
